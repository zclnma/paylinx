    ...
    <div styleName="container" id='weChat'>
        ...
        <div styleName="contentContainer">
            ...
            <div styleName="content">
                <div style={{textAlign:'center'}}styleName="lato-subtitle-orange"><span styleName="orange"></span>CREATE WECHAT OFFICIAL ACCOUNT</div>
                <ul className="body">
        ...
        <div styleName="contentContainer">
            <div styleName="wechatImage1">
                <img src={Mp} alt="" />
            </div>
            <div styleName="content">
                <div style={{textAlign:'center'}} styleName="lato-subtitle-orange"><span styleName="orangeV"></span>WECHAT MOMENTS</div>
                <div className="body">
        ...
        <div styleName="contentContainer">
            ...
            <div styleName="content">
                <div style={{textAlign:'center'}} styleName="lato-subtitle-orange"><span styleName="orangeV"></span>WECHAT MINI PROGRAM</div>
                <div className="body">
